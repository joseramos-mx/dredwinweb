...
export default function WhatsAppFloat() {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = "8719737381" // Reemplazar con el número real
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-3 max-w-xs relative">
            ...
            <p className="text-xs text-gray-600">¿Tienes preguntas sobre nuestros programas? Escríbenos por WhatsApp</p>
            {/* Flecha del tooltip */}
